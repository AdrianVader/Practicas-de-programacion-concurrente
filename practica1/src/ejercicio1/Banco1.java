	  ...
	  public void realizar_reintegro(Cuenta cta, int cantidad, Cliente reintegrador) {
		  ...
		  synchronized(cta){
			  while(cta.saldo(this) < cantidad){
				  espera=true;
				  try {
					  System.out.println("Cliente " + reintegrador.id + ": reintegro de " + cantidad +
		                       " Euros en cuenta #" + cta.numCuenta(this) + " con cajero " + this.id + " no se puede realizar por saldo insuficiente, espera");
					  cta.wait();
				} catch (InterruptedException e) {
					e.printStackTrace();
				}
			  ...
			  if(espera)
				  System.out.println("Cliente " + reintegrador.id + ": reintegro de " + cantidad +
		                  " Euros en cuenta #" + cta.numCuenta(this) + " con cajero " + this.id + " sale de espera, ya hay saldo suficiente");
			  cta.actualizarSaldo(this, cta.saldo(this) - cantidad);
			  cta.notifyAll();
